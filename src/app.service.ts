...
export class AppService {
  getHello(): string {
    return `Welcome to Balancyй, the app that'll have you saying, "Who needs a work-life balance when you can have a 'work, life, and a little bit of crazy' balance!"
